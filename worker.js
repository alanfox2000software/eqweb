  ...
  async fetch(request, env, ctx) {
    ...
    if (url.pathname === "/fetchData" && request.method === "POST") {
      try {
        ...
        let baseBody = `action=eqAndsAll&filter_GEN_mg=${mg}&lang=zh_CN&page.order=DESC&page.orderBy=dateTime&page.pageNo=1&page.pageSize=20&pn=com.topstcn.eq&time=${time}&type=${type}&vcode=346`;
